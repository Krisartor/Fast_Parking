    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="container">
                ...
                <h2>Bienvenido a Fast Parking </h2>
                                            ...
                                            <div class="col">
                                                <center>
                                                    ...
                                                    <button class="btn btn-info" id="btn_ocupado<?php echo $id_map;?>" data-toggle="modal"
                                                            ...
                                                            <img src="<?php echo $URL;?>/public/imagenes/carro.png" width="100PX" alt="">
                                                    </button>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="form-group row">
                                                                        <label for="staticEmail" class="col-sm-4 col-form-label">NIT/CI: </label>
                                                                        <div class="col-sm-8">
                                                                            <input type="text" class="form-control" value="<?php echo $nit_ci;?>" id="nit_ci_cliente<?php echo $id_map;?>" disabled>
                                                                        </div>
                                                                    </div>
