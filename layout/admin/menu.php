...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $URL;?>/principal.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Fast Parking</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo $URL;?>/public/imagenes/user-icon.webp" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
