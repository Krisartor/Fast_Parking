...
if($nombre_cliente == ""){
   // echo "el cliente es nuevo";
    ...
    <div class="form-group row">
        <label for="staticEmail" class="col-sm-4 col-form-label">Nombre: <span><b style="color: red">*</b></span></label>
        <div class="col-sm-8">
    ...
    <div class="form-group row">
        <label for="staticEmail" class="col-sm-4 col-form-label">NIT/CI: <span><b style="color: red">*</b></span></label>
        <div class="col-sm-8">
